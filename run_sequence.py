...
def parse_args():
    ...
    parser.add_argument('--content', type=str, default='content',
                        help='File path of input folder', required=True)

    parser.add_argument('--output', type=str, default='output',
                        help='File path of output folder', required=True)
...
def main():
    ...
    for image_name in os.listdir(args.content):
        try:
            content_image = utils.load_image(args.content + "\\" + image_name)
        except:
            # current file is not an image, skip it
            continue
        ...
        # save result
        utils.save_image(output_image, args.output + "\\" + image_name)
